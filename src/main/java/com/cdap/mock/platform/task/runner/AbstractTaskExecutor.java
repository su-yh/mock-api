...
public abstract class AbstractTaskExecutor extends Thread {
    ...
    protected final EnvDatasourcePropertiesEntity cdsDataSource;
    protected final EnvDatasourcePropertiesEntity pgDataSource;
