...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='广告创意表';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='素材文件夹表';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='FB推广链接';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='广告模板草稿';
...
CREATE TABLE ad_template_formal (
                                      ...
                                      PRIMARY KEY (id) USING BTREE,
                                      UNIQUE KEY uni_uid_name (owner_user_id,name,delete_flag) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='广告模板表';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='广告模板预览表';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='个号授权过期提示表';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='FB广告账户收藏表';
...
CREATE TABLE fb_account_convert_event (
                                            ...
                                            created_by_id bigint NOT NULL COMMENT '创建者ID',
                                            update_by_id bigint DEFAULT NULL COMMENT '修改者ID',
                                            created_at datetime DEFAULT NULL COMMENT '转化事件创建时间',
                                            updated_at datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '数据更新时间',
                                            PRIMARY KEY (id)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='FB广告账户转化事件表';
...
CREATE TABLE fb_account_pixel_code (
                                         ...
                                         created_by_id bigint NOT NULL COMMENT '创建者ID',
                                         update_by_id bigint DEFAULT NULL COMMENT '修改者ID',
                                         created_at datetime DEFAULT NULL COMMENT '像素创建时间',
                                         updated_at datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '数据更新时间',
                                         PRIMARY KEY (id)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='FB广告账户像素代码表';
...
CREATE TABLE fb_ad_campaign (
                                  ...
                                  PRIMARY KEY (id) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='创建的FB广告系列v2';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='FB广告系列关联表';
...
CREATE TABLE fb_ad_campaign_resource (
                                           ...
                                           campaign_created_at datetime DEFAULT NULL COMMENT '广告系列创建日期',
                                           campaign_updated_at datetime DEFAULT NULL COMMENT '广告系列修改日期',
                                           created_by_id bigint NOT NULL COMMENT '创建者ID',
                                           update_by_id bigint DEFAULT NULL COMMENT '修改者ID',
                                           created_at datetime DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
                                           updated_at datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='FB广告系列资源表';
...
CREATE TABLE fb_ad_material_relation (
                                           ...
                                           updated_at datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
                                           PRIMARY KEY (id)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='本地素材和广告关系表';
...
CREATE TABLE fb_ad_material_resource (
                                           ...
                                           updated_at datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
                                           PRIMARY KEY (id)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='广告素材表';
...
CREATE TABLE fb_ad_resource (
                                  ...
                                  ad_created_at datetime DEFAULT NULL COMMENT '广告创建日期',
                                  ad_updated_at datetime DEFAULT NULL COMMENT '广告修改日期',
                                  created_by_id bigint NOT NULL COMMENT '创建者ID',
                                  update_by_id bigint DEFAULT NULL COMMENT '修改者ID',
                                  created_at datetime DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
                                  updated_at datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='FB广告创意资源表';
...
CREATE TABLE fb_ad_set_resource (
                                      ...
                                      budget_normal text COMMENT '出价与预算(应用广告)',
                                      placement_properties text COMMENT '版位',
                                      ad_set_created_at datetime DEFAULT NULL COMMENT '广告组创建日期',
                                      ad_set_updated_at datetime DEFAULT NULL COMMENT '广告组修改日期',
                                      created_by_id bigint NOT NULL COMMENT '创建者ID',
                                      update_by_id bigint DEFAULT NULL COMMENT '修改者ID',
                                      created_at datetime DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
                                      updated_at datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='FB广告组资源表';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='FB广告账号管理表';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='FB广告账号和推广应用关联表';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='FB商务管理平台';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='FB数据权限表';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='定向包管理';
...
CREATE TABLE fb_personal_account_plus (
                                            ...
                                            KEY idx_status (status) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='FB个人账号管理表';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='FB个号和广告账号关联表';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='FB个号和主页关联表';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='FB推广应用';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='FB公共主页管理表';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='FB地区组管理表';

-- ----------------------------
-- Table structure for task_account_resource
-- ----------------------------
CREATE TABLE task_account_resource (
                                         id bigint NOT NULL AUTO_INCREMENT COMMENT '主键ID',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='FB授权认证记录表';

-- ----------------------------
-- Table structure for task_account_resource_detail
-- ----------------------------
CREATE TABLE task_account_resource_detail (
                                                ...
                                                updated_at datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
                                                PRIMARY KEY (id)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='FB账号资源同步任务明细表';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='广告任务中心，明细';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='广告任务明细扩展：广告素材';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='广告任务明细扩展：广告创意';

-- ----------------------------
-- Table structure for task_campaign_resource
-- ----------------------------
CREATE TABLE task_campaign_resource (
                                          ...
                                          updated_at datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
                                          PRIMARY KEY (id)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='FB广告系列资源同步任务表';

-- ----------------------------
-- Table structure for task_campaign_resource_detail
-- ----------------------------
...
CREATE TABLE task_management_ad (
                                      ...
                                      KEY idx_status (status) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='广告任务中心';
